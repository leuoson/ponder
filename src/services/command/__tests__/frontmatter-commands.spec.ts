...
\`\`\``
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".ponder", "commands", "setup.md"),
				description: "Sets up the development environment",
...
Global setup instructions.`
			...
			expect(result).toEqual({
				...
				source: "global",
				filePath: expect.stringContaining(path.join(".ponder", "commands", "setup.md")),
				description: "Global setup command",
				argumentHint: undefined,
			})
		})
...
Create a new release.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".ponder", "commands", "release.md"),
				description: "Create a new release of the Roo Code extension",
...
Deploy the application.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".ponder", "commands", "deploy.md"),
				description: "Deploy application to environment",
